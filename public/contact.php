...
// Cargar configuración para mostrar datos de contacto
require_once __DIR__ . '/../src/Helpers/SiteConfig.php';
$contact_email = SiteConfig::get('contact_email', 'info@eventix.com.ar');
$contact_phone = SiteConfig::get('contact_phone', '+54 9 11 1234-5678');
$contact_address = SiteConfig::get('contact_address', 'Avellaneda, Santa Fe, Argentina');
$support_hours = SiteConfig::get('support_hours', 'Lun-Vie 9:00-18:00');
$site_domain = SiteConfig::get('site_domain', 'www.eventix.com.ar');
        ...
        <div class="contact-info-section">
            ...
            <div class="contact-info-item">
                ...
                <div class="contact-info-content">
                    <h3>Email</h3>
                    <p><a href="mailto:<?= htmlspecialchars($contact_email) ?>"><?= htmlspecialchars($contact_email) ?></a></p>
            ...
            <div class="contact-info-item">
                ...
                <div class="contact-info-content">
                    <h3>Sitio Web</h3>
                    <p><a href="https://<?= htmlspecialchars($site_domain) ?>" target="_blank"><?= htmlspecialchars($site_domain) ?></a></p>
                </div>
            </div>
            ...
            <div class="social-links">
                ...
                <a href="<?= htmlspecialchars($social_facebook) ?>" class="social-link" title="Facebook" target="_blank">
                ...
                <a href="<?= htmlspecialchars($social_twitter) ?>" class="social-link" title="Twitter" target="_blank">
                    <svg xmlns="http://www.w3.org/2000/svg" fill="currentColor" viewBox="0 0 24 24">
                ...
                <a href="<?= htmlspecialchars($social_instagram) ?>" class="social-link" title="Instagram" target="_blank">
                    <svg xmlns="http://www.w3.org/2000/svg" fill="currentColor" viewBox="0 0 24 24">
                ...
                <a href="<?= htmlspecialchars($social_youtube) ?>" class="social-link" title="YouTube" target="_blank">
                    <svg xmlns="http://www.w3.org/2000/svg" fill="currentColor" viewBox="0 0 24 24">
